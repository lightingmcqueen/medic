...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { address: @clinic.address, admin_id: @clinic.admin_id, coordinator: @clinic.coordinator, description: @clinic.description, title: @clinic.title }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { address: @clinic.address, admin_id: @clinic.admin_id, coordinator: @clinic.coordinator, description: @clinic.description, title: @clinic.title }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
